...
export const COMMAND_MANIFEST: CommandManifestEntry[] = [
  ...
  entry({ name: 'agent.explain-error', description: 'Explain known Bmall error codes and map them to CLI remediation commands', audience: 'core', access: 'read', strategy: 'none', args: [{ name: 'error-code', type: 'str' }, { name: 'message', type: 'str' }], columns: ['code', 'rootCause', 'commands'] }),
